...
\begin{figure}
    ...
    \caption{Curva di transizione del TES. La resistenza viene mantenuta a metà della curva, così da poter passare rapidamente dallo stato superconduttore allo stato normale in un intervallo di temperatura molto ristretto.}
    \label{fig:tes_curve}
\end{figure}
